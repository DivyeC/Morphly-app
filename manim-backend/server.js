...
app.use(cors({ origin: ["http://localhost:3000", "http://localhost:3001","https://front-end-production-1019.up.railway.app/",  "https://morphly-app-production-front.up.railway.app"] }));
